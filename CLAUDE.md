...
- **Tous les mondes ne sont pas sombres** (`generation/v3`). La charte choisissait le registre grave par réflexe ; le prompt liste désormais ce qu'une aventure peut être, et l'arc rappelle qu'une enquête tranquille ou une dette à rembourser valent une catastrophe.
