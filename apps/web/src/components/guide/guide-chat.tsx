...
export function GuideChat() {
  ...
  return (
    <Container as="section" className="pb-24 sm:pb-32">
      {/* Largeur de la colonne du hero : le panneau se lit comme sa suite. */}
      <div className="max-w-3xl rounded-card border border-line bg-abyss p-4 sm:p-6">
        <div className="px-1">
          <h2 className="font-voice text-subtitle text-balance text-vellum">
            {t("title")}
          </h2>
          <p className="mt-2 text-ui-sm text-pretty text-vellum-2">{t("intro")}</p>
        </div>
              ...
              <li key={index} className="flex flex-col gap-3">
                ...
                >
                  ...
                  {turn.answer ? (
                    ...
                    !turn.error && (
                      <p className="mt-1 text-ui text-vellum-3">{t("thinking")}</p>
                    )
                  )}
                  ...
                  {turn.partial && (
                    <p className="mt-2 text-ui-sm text-vellum-3">{t("partial")}</p>
                  )}
                  {turn.error && (
